...
class rnn_input_layer(layers.Layer):
	...
	def __init__(self,receptive_filter_size=4, batch_size=1):

		super(rnn_input_layer, self).__init__()
                
                self.batch_size = batch_size
		self.receptive_filter_size = receptive_filter_size
		self.input_size = receptive_filter_size * receptive_filter_size
                #self.dim = dim
	...
	def call(self, X):
		...
		input_size1 = input_shape[3]*self.input_size
		return [(input_shape[0],image_patches_height*image_patches_width,input_size1),(input_shape[0],image_patches_height*image_patches_width,input_size1),(input_shape[0],image_patches_height*image_patches_width,input_size1),(input_shape[0],image_patches_height*image_patches_width,input_size1)]
